...
function sexy_animations_styles_scripts() {
  ...
  // src JS
  wp_enqueue_script( 'markup', SEXY_ANIMATIONS_URL . '/dist/js/sexyAnimations.js', array('jquery'), '', true );

  // CSS Libraries
  wp_enqueue_style( 'animate-lib', SEXY_ANIMATIONS_URL . '/node_modules/animate.css/animate.min.css' );
